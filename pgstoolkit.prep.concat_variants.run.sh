...
gzip -vf ${STUDYDIR}/aegscombo.topmed_r3_f10_b38.split_norm_af_filter.8bit.variantlist.txt
...
gzip -vf ${STUDYDIR}/aegscombo.topmed_r3_f10_b38.split_norm_af_filter.16bit.variantlist.txt