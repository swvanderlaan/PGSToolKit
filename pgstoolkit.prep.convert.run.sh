...
if [ "$CHR" -eq 23 ]; then
    $PLINK --vcf ${STUDYDIR}/aegscombo.topmed_r3_f10_b38.split_norm_af_filter.chrX.vcf.gz --export bgen-1.2 bits=8 --out ${STUDYDIR}/aegscombo.topmed_r3_f10_b38.split_norm_af_filter.8bit.chr${CHR}
...
if [ "$CHR" -eq 23 ]; then
    $PLINK --vcf ${STUDYDIR}/aegscombo.topmed_r3_f10_b38.split_norm_af_filter.chrX.vcf.gz --export bgen-1.2 --out ${STUDYDIR}/aegscombo.topmed_r3_f10_b38.split_norm_af_filter.16bit.chr${CHR}
